<?
$judul = "Laporan Aktifitas-" . date('dmY');
...
<body>
    <table width="100%">
        <tr>
            <td colspan=3 style="font-family:times;font-size:14pt;font-weight:bold;"><u>Laporan Log Aktifitas Aplikasi Restitusi PLN</td>
        </tr>
        <tr>
