...
<body class="hold-transition login-page">
		...
		<div class="login-box-body">
			...
			<div class="row">
				...
				<div class="col-xs-6 text-right">
					...
					<br><br>
					<a href="<?= base_url(); ?>mobilelogin">Versi Mobile</a>
				</div>
			</div>
	...
	<div class="modal fade" id="lupa" tabindex="-1" role="dialog" aria-labelledby="lupaLabel" aria-hidden="true">
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				...
				<form id="frm_lupa" name="frm_lupa" action="<?= base_url(); ?>login/reset" method="post">
	...
	<div class="modal fade" id="registrasi" tabindex="-1" role="dialog" aria-labelledby="registrasiLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<form class="form-horizontal" id="frm_registrasi" name="frm_registrasi" action="<?= base_url(); ?>login/registrasi" method="post">
	...
	<script>
		...
		$('#pilih_foto').change(function() {
			if (this.files[0] != "") {
				if (this.files[0].size > 6000000) {
					...
					var target_proses = lokasi + "login/upload/" + nama_file;
		...
		$("#persno").change(function() {
			...
			var url = lokasi + "login/cek_persno/" + persno;
		...
		$("#email").change(function() {
			...
			var url = lokasi + "login/cek_email/" + email;
			$.getJSON(url, function(result) {
				console.log(result);
				$.each(result, function(i, field) {
					if (field.jml != 0) {
