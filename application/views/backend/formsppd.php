        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form class="form-horizontal" method="POST" action="<?= base_url(); ?>sppd/proses/<?= $proses; ?>">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <? if ($this->session->userdata('level') != 0 && $this->session->userdata('level') != "3") { ?>
                                                                                <div class="input-group-btn">
                                                                                    <a href="#" class="btn btn-default" data-toggle="modal" data-target="#daftar-pegawai" onclick="daftar_pegawai(1)"><i class="fa fa-users"></i></a>
                                                                                </div>
                                                                            <? } ?>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="box box-primary">
                                                            ...
                                                            <div class="box-body">
                                                                <div id="div_tripno" class="form-group">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <input type="text" class="form-control" id="trip_no" name="trip_no" value="<?= $trip_no; ?>" maxlength=100 placeholder="Nomor Trip" required>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-7">
                                                                        <input type="text" class="form-control" id="dari" name="dari" value="<?= $dari; ?>" maxlength=150 placeholder="Tempat Berangkat" required>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="col-sm-2 control-label">Tempat Tujuan</label>
                                                                    <div class="col-sm-7">
                                                                        <input type="text" class="form-control" id="ke" name="ke" value="<?= $ke; ?>" maxlength=150 placeholder="Tempat Tujuan" required>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="col-sm-2 control-label">Tanggal Berangkat</label>
                                                                    <div class="col-sm-3">
                                                                        <input type="date" class="form-control" id="tgl_berangkat" name="tgl_berangkat" value="<?= $tgl_berangkat; ?>" max="<?= date('Y-m-d'); ?>" required>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="col-sm-2 control-label">Tanggal Kembali</label>
                                                                    <div class="col-sm-3">
                                                                        <input type="date" class="form-control" id="tgl_pulang" name="tgl_pulang" value="<?= $tgl_pulang; ?>" max="<?= date('Y-m-d'); ?>" required>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                        ...
                                                        <div class="box box-primary">
                                                            ...
                                                            <div class="box-body text-center">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xs-12">
                                                                        <code>Klik pada gambar untuk mengupload berkas</code>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="box-body">
                                                                <div class="form-group">
                                                                    <div class="col-sm-12">
                                                                        ...
                                                                        <code>Apabila tidak cukup silakan dilampirkan dengan mengklik gambar di samping kiri</code>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="box">
                                                            ...
                                                            <div class="box-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <input type="text" class="form-control formatnumber" id="nominal_pergi" name="nominal_pergi" value="<?= number_format($nominal_pergi, 0, '.', ','); ?>" min=0 max=999999999 required>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                        ...
                                        <div class="box box-primary box-solid">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <textarea class="form-control" id="catatan" name="catatan" rows="3" placeholder="Catatan perubahan SPPD (jika ada) ..." style="resize:none;"><?= $catatan; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label text-left">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group-btn">
                                                                <a href="#" class="btn btn-default" data-toggle="modal" data-target="#daftar-pegawai" onclick="daftar_pegawai(2)"><i class="fa fa-users"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
