...
<body class="hold-transition skin-blue layout-top-nav">
    ...
    <script>
        function pilih(kode, pers_no, email, nama, jabatan, unit, bidang, area, foto, ttd) {
            ...
            if (kelompok == 1) {
                window.parent.$('#kd_pegawai').val(kode);
                window.parent.$('#foto').attr("src", foto);
                window.parent.$('#ttd').attr("src", ttd);
                window.parent.$('#persno').val(pers_no);
                window.parent.$('#email').val(email);
                window.parent.$('#nama').val(nama);
                window.parent.$('#jabatan').val(jabatan);
                window.parent.$('#unit').val(unit);
                window.parent.$('#bidang').val(bidang);
                window.parent.$("#area").val(area);

                window.parent.$('#table_nama').html(nama);
                window.parent.$('#table_persno').html(pers_no);
                window.parent.$('#table_jabatan').html(jabatan);
                window.parent.$('#table_unit').html(unit);

                window.parent.$('#ttd_pegawai').attr("src", ttd);
                window.parent.$('#ttd_nama_pegawai').html(nama);
