...
class Sppd extends CI_Controller
{
    ...
    public function index($page = 1, $isicari = "-", $katcari = "-", $pesan = "", $isipesan = "")
    {
        ...
        $this->load->view('backend/sppd', $data);
    ...
    public function formulir($proses, $kode = "")
    {
            ...
            case "2":
                ...
                foreach ($sppd as $s) {
                    ...
                    foreach ($pegawai as $p) {
                        ...
                        if ($p->ttd != "" && $s->approve == 1  && substr_count($p->ttd, "data:image/png;base64") == 0) {
        ...
        if ($data['approve'] == 0) {
            ...
            $this->load->view('body/body_atas');
            $this->load->view('body/menu_kiri');
            $this->load->view('backend/formsppd', $data);
            $this->load->view('body/body_bawah');
        } else {
            $pesan = 3;
            ...
            redirect("sppd/index/1/-/-/$pesan/$msg");
        }
    }
    ...
    public function proses($proses = 1, $kode = "", $nomor_trip = "", $approve = "")
    {
        ...
        switch ($proses) {
            case 1:
                ...
                $isi = $data_pegawai . "<br><br>Telah melaporkan perjalanan dinas nya dan menunggu proses <b>Approval</b>";
    ...
    public function daftar_pegawai($kelompok = 1, $page = 1, $isicari = "-")
    {
        ...
        $this->load->view('backend/daftar_pegawai', $data);
    }
    ...
    public function cetak($kode = "", $cetak = "yes")
    {
        ...
        if ($cetak == "yes") {
            ...
            $html = $this->load->view('backend/cetak', $data, true);
            $mpdf->WriteHTML($html);
