...
class Mobileprofil extends CI_Controller
{
    ...
    public function index($pesan = "", $isipesan = "")
    {
        ...
        $pegawai = $this->mod_profil->daftar($this->session->userdata('kode_user'))->result();
        ...
        //save log
        $this->log_lib->log_info("Akses halaman formulir profil");
    ...
    public function proses()
    {
        ...
        redirect("mobileprofil/index/$pesan/$msg");
    }
    ...
    public function uploadttd($nama_file)
    {
        $config['upload_path']        = './upload/pegawai';
        $config['allowed_types']     = 'gif|jpg|png|bmp';
        $config['file_name']        = $nama_file;
